...
{
    public static readonly Regex Mention = new Regex("4(s)?ta(c)?k|fo(r(e)?[esk]|ur|r)t[r]?a(c)?k|129708505|test(ing)?( )?(guy|individual)", RegexOptions.IgnoreCase | RegexOptions.Compiled, TimeSpan.FromMilliseconds(50));
